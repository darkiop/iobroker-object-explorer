...
<tr style="background-color:#1a3a1f"><td>FE-074</td><td>Feature A — Auto-create aliases from device/channel: AutoCreateAliasModal with child-state checkboxes, optional room/function selector, batch create with progress.</td><td>Feature</td><td>medium</td><td>M</td><td>done</td></tr>
<tr style="background-color:#1a3a1f"><td>FE-075</td><td>Feature B — Find &amp; Replace in alias targets: AliasReplaceModal with old/new input, preview table (red→green), batch update with live progress. Triggered via right-click on alias.* tree node.</td><td>Feature</td><td>medium</td><td>M</td><td>done</td></tr>
<tr style="background-color:#1a3a1f"><td>FE-076</td><td>Feature C — Dangling aliases filter: show only alias.0.* objects without a valid target; count badge in sidebar; operates on full allObjects (not pattern-filtered).</td><td>Feature</td><td>medium</td><td>M</td><td>done</td></tr>
<tr style="background-color:#1a3a1f"><td>FE-077</td><td>Feature D — Alias copy with target replacement: CopyDatapointModal shows "replace alias target" section for alias.0.* sources with replaceFrom/replaceTo inputs and live preview.</td><td>Feature</td><td>medium</td><td>S</td><td>done</td></tr>
