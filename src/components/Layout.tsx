      ...
      <header className="relative flex items-center justify-between px-4 py-3 bg-gray-100 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 shrink-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            title={theme === 'light' ? 'Dark Mode' : theme === 'dark' ? 'Abyss Mode' : theme === 'abyss' ? 'Catppuccin Frappé Mode' : theme === 'catppuccin-frappe' ? 'Catppuccin Macchiato Mode' : theme === 'catppuccin-macchiato' ? 'Catppuccin Mocha Mode' : 'Light Mode'}
            aria-label={theme === 'light' ? 'Dark Mode' : theme === 'dark' ? 'Abyss Mode' : theme === 'abyss' ? 'Catppuccin Frappé Mode' : theme === 'catppuccin-frappe' ? 'Catppuccin Macchiato Mode' : theme === 'catppuccin-macchiato' ? 'Catppuccin Mocha Mode' : 'Light Mode'}
          >
            {theme === 'light' ? <Moon size={16} /> : theme === 'dark' ? <Eclipse size={16} /> : theme === 'abyss' ? <Flower2 size={16} /> : theme === 'catppuccin-frappe' ? <Flower2 size={16} /> : theme === 'catppuccin-macchiato' ? <Flower2 size={16} /> : <Sun size={16} />}
          </button>
          <button
