      ...
      <div className="flex items-center gap-1.5">
        {role ? (
          <>
            ...
            <Tooltip content={isEn ? 'Edit role' : 'Rolle bearbeiten'}><Pencil size={12} className="ml-auto opacity-0 group-hover/role:opacity-100 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 shrink-0 transition-opacity" /></Tooltip>
          </>
        ) : (
          <>
